...
{
public:
	ColisionModule(Listaestatica<Rigidbody>* wall_and_floor, Listaestatica<Rigidbody>* obstacles, Listaestatica<Monster>* monsters, Rigidbody* player, Lista<Projetil>* projeteis);
